...
class Adjust_labels:
    ...
    def targetStream(self, labels, data):
        ...
        elif(labels == ['1', '2', '3', '4', '5', '6']):
            index = [0 if int(i) == 6 else int(i) for i in data[:, -1]]
        ...
        elif(labels == ['ae-aegypti-female', 'ae-aegypti-male', 'ae-albopictus-female', 'ae-albopictus-male', 'cx-quinq-female', 'cx-quinq-male']):    
            index = [0 if i == 'ae-aegypti-female' else 
                     1 if i == 'ae-aegypti-male' else
                     2 if i == 'ae-albopictus-female' else
                     3 if i == 'ae-albopictus-male' else
                     4 if i == 'cx-quinq-female' else
                     5 if i == 'cx-quinq-male' else 
                     i for i in data[:, -1]]
        else:
            index = data[:, -1]
