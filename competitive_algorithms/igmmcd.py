...
class IGMM_CD(PREQUENTIAL_SUPER):
    def __init__(self, sigma_ini=0.05, cver=0.01, T=3, window_size=50):
        ...
        for i, X in enumerate(self.STREAM):
            ...
            if(run):
                ...
                if(i >= self.window_size):
                    ...
                    self.printIterative(i-self.window_size)
...
def main():
    ...
    igmmcd = IGMM_CD(window_size=200)
    igmmcd.run(labels, stream_records, cross_validation=True, qtd_folds=30, fold=1)
